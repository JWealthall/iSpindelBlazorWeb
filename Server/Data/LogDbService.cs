...
namespace iSpindelBlazorWeb.Server.Data
{
    ...
    public class LogDbService
    {
        ...
        public async Task<List<BatchSummaryModel>> BatchSummaryList(Guid? deviceId = null, Guid? batchId = null, bool current = false)
        {
            ...
            var bs = from b in _context.Batches
                     join ls in (
                         _context.Logs.Join(
                             ...
                             , (l, lsj) => new LogSummaryModel() { BatchId = l.BatchId, Date = l.Date, Gravity = l.Gravity, Temperature = l.Temperature, TempUnits = l.TempUnits })
                     ...
                     join le in (
                         _context.Logs.Join(
                             ...
                             , (l, lej) => new LogSummaryModel() { BatchId = l.BatchId, Date = l.Date, Gravity = l.Gravity, Temperature = l.Temperature })
                     ...
                     select new BatchSummaryModel(b, ls, le, lx.Gravity, ln.Gravity, lh.Temperature, ll.Temperature, la.Temperature);
        ...
        public async Task<List<DeviceSummaryModel>> DeviceSummaryList(Guid? deviceId = null)
        {
            /*
            ...
            */
            ...
            var ds = from d in _context.Devices
                     ...
                     select new DeviceSummaryModel(d, l);
        ...
        public async Task<bool> Log(SpindelLogModel data)
        {
            if (ReadOnly) return false;
            try
            {
